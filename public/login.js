...
function draw(){
    ...
    textSize(30);
    textAlign(CENTER, CENTER);
    BetterText('Login', SignupButton.x + SignupButton.w/2, SignupButton.y + SignupButton.h/2);
};

function mousePressed(){
    SignupButton.click(()=>{
        httpPost('/loginAccount', {name: CurrentUsername, password: CurrentPassword}, data =>{
